<%-- 
    Document   : uploadMarketplaceListing
    Created on : 15 Jun, 2018, 3:53:30 PM
    Author     : Ritesh
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Bulk Listing Upload</a></li>
                 </ul>
                <!-- END BREADCRUMB --> 
                            ...
                            <form:form cssClass="form-horizontal" modelAttribute="uploadFeed" name="form1" id="form1" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.uploadListing"/></h3>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr><td>Marketplace Listing ID</td><td>Marketplace Listing ID of Marketplace</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                            <tr><td>SKU</td><td>SKU for the Listing</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
