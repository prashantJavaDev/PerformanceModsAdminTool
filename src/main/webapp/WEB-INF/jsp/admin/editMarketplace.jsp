<%-- 
    Document   : editMarketplace
    Created on : 6 Mar, 2017, 4:16:00 PM
    Author     : Ritesh
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="../admin/home.htm">Marketplace</a></li>
                    <li><a href="#">Edit Marketplace</a></li>
                </ul>
                <!-- END BREADCRUMB --> 
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" commandName="marketplace" method="POST" name="form1" id="form1" action="../admin/editMarketplace.htm">
                                <form:hidden path="marketplaceId"/>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.editMarketplace"/></h3>
                                    </div>
