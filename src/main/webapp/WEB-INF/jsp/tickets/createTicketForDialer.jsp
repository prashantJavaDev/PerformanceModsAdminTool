<%-- 
    Document   : createTicketForDialer
    Created on : 26 July, 2018, 11:45:03 PM
    Author     : Ritesh
--%>
...
<html lang="en">
    ...
    <body onload="fieldsByStatus();
        fieldsByType();getTicketListByPhoneNumber();">
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Create Ticket For Dialer</a></li>
                </ul>
                <!-- END BREADCRUMB --> 
        ...
        <script type="text/javascript">
            ...
            function getTicketListByPhoneNumber() {
                var custPhoneNumber = $('#custPhoneNumber').val();
                //alert($('#orderId').val());
                $.ajax({
                    url: "../ajax/getTicketListByPhoneNumber.htm",
                    dataType: "json",
                    data: ({'custPhoneNumber': custPhoneNumber}),
                    success: function(json) {
                        if (json.length > 0) {
                            $('#displayTable').show();
