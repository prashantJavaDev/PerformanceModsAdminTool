<%-- 
    Document   : uploadInvoice
    Created on : 14 May, 2018, 3:24:45 PM
    Author     : Pallavi
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
                            ...
                            <form:form cssClass="form-horizontal" modelAttribute="uploadFeed" name="form1" id="form1" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.uploadInvoiceFeed"/></h3>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr><td>PO Number</td><td>Purchase Order Number</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                            <tr><td>MPN</td><td>Manufacturer Part Number</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                            <tr><td>Price</td><td>Invoice Cost</td><td style="text-align: center;">Yes</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                        </table>
                                    </div>
            ...
            <script type="text/javascript">
                ...
                var jvalidate = $("#form1").validate({
                    ...
                    messages:{
                        multipartFile:"Please select .csv or .xls or .xlsx file"  
                    },
