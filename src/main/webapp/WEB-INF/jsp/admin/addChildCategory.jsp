<%-- 
    ...
    Created on : 20 Aug, 2018, 1:40:26 PM
    Author     : Ritesh
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Map Child Category</a></li>
                </ul>
                <!-- END BREADCRUMB --> 
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">   
                        <div class="col-md-12">
                            <form:form id="form1" commandName="subCategory" method="POST" name="form1" class="form-horizontal">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.addChildCategory"/></h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    <form:select path="subCategoryId" id="subCategoryId" cssClass="form-control select" onchange="showChildCategoryList();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12" >
                                                <div class="form-group">
                                                    <form:select path="childCategoryId"  cssClass="form-control select" multiple="true">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">Add Child Category</h4>
                    </div>
                    <div class="modal-body">
                        <form name="form3" id="form3">
                            <div class="form-group">
                                <label for="message-text" class="control-label req"><spring:message code="childCategory"/></label>
                                <input type="text" name="childCategoryDesc" id="childCategoryDesc" class=" req form-control"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" onclick="addChildCategory();">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function showChildCategoryList() {
                ...
                $.ajax({
                    ...
                    url: "ajaxGetChildCategoryListBySubCategoryId.htm",
                    dataType: "json",
                    success: function(json) {
                        $('#childCategoryId').val(json);
                        $('#childCategoryId').selectpicker('refresh');
                    },
                    error: function(e) {
            ...
            function addChildCategory() {
                ...
                if (form.valid()) {
                    $.ajax({
                        url: "../admin/ajaxAddChildCategory.htm",
                        data: {
                            childCategoryDesc: $("#childCategoryDesc").val(),
                        ...
                        success: function(json) {
                            if (json != null) {
                                if (json.active == 1) {
                                    $("#childCategoryId").append($("<option></option>").attr("value", json.id).text(json.label));
                                    $('#childCategoryId').selectpicker('refresh');
                                }
                            }
