<%-- 
    ...
    Created on : 7 Feb, 2017, 5:27:07 PM
    Author     : Ritesh
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="../admin/home.htm">Warehouse</a></li>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" commandName="warehouse" method="POST" name="form1" id="form1" action="../admin/editWarehouse.htm">
                                <form:hidden path="warehouseId"/>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.editWarehouse"/></h3>
                                    </div>
