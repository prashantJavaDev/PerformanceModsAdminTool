<%-- 
Document   : warehouseShipping
Created on : 2 Aug, 2017, 5:31:16 PM
Author     : Ritesh
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" modelAttribute="shippingDetails" name="form1" id="form1" method="post" >
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.addWarehouseShipping"/></h3>
                                    </div>
