        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Upload Marketplace Fees</a></li>
                </ul>
                <!-- END BREADCRUMB --> 
                            ...
                            <form:form cssClass="form-horizontal" modelAttribute="uploadFeed" name="form1" id="form1" method="post" enctype="multipart/form-data">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><spring:message code="title.uploadAmazonFees"/></h3>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr><td>Marketplace ID</td><td>ASIN, NewEggID or SKU of the listings</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                            <tr><td>Fees</td><td>Marketplace commission percentage</td><td style="text-align: center;">No</td><td style="text-align: center;"><b>Yes</b></td></tr>
                                        </table>
                                    </div>
